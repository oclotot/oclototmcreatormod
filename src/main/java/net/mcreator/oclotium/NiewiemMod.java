...
import net.mcreator.oclotium.init.NiewiemModPaintings;
...
public class NiewiemMod {
	...
	public NiewiemMod() {
		...
		NiewiemModPaintings.REGISTRY.register(bus);
		NiewiemModParticleTypes.REGISTRY.register(bus);

		NiewiemModMenus.REGISTRY.register(bus);
	}
